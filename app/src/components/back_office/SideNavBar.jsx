      ...
      >
        <div className="h-full px-2 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
          ...
          <button
            ...
            className={`p-2 ${!isSidebarOpen ? 'bg-gray-200 hover:bg-gray-300' : 'hover:bg-gray-100'}  rounded-full z-50 transition-all duration-300 ease-in-out transform w-10 h-10 flex items-center justify-center`}
          >
            <svg
            ...
            <ul className="space-y-6 font-medium">
              ...
              <li>
                ...
                >
                  <div className="bg-gray-500 px-1 rounded-full hover:bg-black">
                    <i className="fa-solid fa-money-bill text-white transition duration-75"></i>
                  </div>
              ...
              <li>
                <Link className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                  <div className="bg-gray-500 px-1 rounded-full hover:bg-black">
                    <i className="fa-solid fa-question text-white transition duration-75"></i>
                  </div>
